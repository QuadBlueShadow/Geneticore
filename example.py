...
alg = CRGeneticAlg(base_net=base_net, episodes_per_gen=1, num_nets=N_NETS, total_episodes=total_episodes, max_fitness=max_fitness) #Create the algorithm and put the base net in it
