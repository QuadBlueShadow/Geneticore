...
base_net = Net(net_arr=[237, 64, 64, act_parser.get_action_space()], act_parser=act_parser) #Create a base net to work with
...
env = rlgym_sim.make(reward_fn=VelocityPlayerToBallReward(), obs_builder=AdvancedObsPadder())
